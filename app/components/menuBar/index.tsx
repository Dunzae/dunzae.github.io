...
export function MenuBar({ className }: MenuBarProps) {
    ...
    return (
        <div className={`${className} fixed bottom-0 left-0 right-0 z-[1001] lg:static lg:flex lg:min-w-[100px] lg:h-full`}>
            ...
            <div
                className={`fixed top-[100px] bottom-[68px] left-0 right-0 w-full overflow-y-scroll p-4 bg-[#fafafa] 
                    lg:static lg:w-[450px] lg:border-r-2 lg:shadow-[4px_0_24px_rgba(0,0,0,0.15)] ${isShown ? 'flex' : 'hidden'}`}
            >
