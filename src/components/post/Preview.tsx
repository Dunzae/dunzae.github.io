...
function PostPreviewComponent({
    ...
    return <div className="border-b-2 p-4 mb-4 border-[#E6E6E6] bg-white rounded-[20px] lg:min-w-[660px]">
        <div className={`flex flex-col lg:flex-row max-h-[255px] overflow-x-hidden overflow-y-hidden gap-4 mb-4 justify-between`}>
            <div className="flex flex-grow flex-col lg:w-[60%] basis-0">
                ...
                <div className="lg:flex lg:flex-col flex-shrink">
                    <p className="text-[#191919] mb-2 text-[22px] font-Roboto font-bold break-words">{title}</p>
                    <p className="text-[#292929] h-full break-words leading-6 font-Poppins font-normal overflow-y-hidden text-sm">
                        {content}
                    </p>
                </div>
            </div>
