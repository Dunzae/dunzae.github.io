...
function ButtonGroup() {
    return (
        <>
            <button className='hidden w-fit rounded-lg gap-2 justify-center items-center font-NanumGothic font-bold text-md bg-white shadow-lg p-2 lg:flex lg:w-full lg:justify-start lg:rounded-none'>
